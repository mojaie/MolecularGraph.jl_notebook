...
md"
- The default atom/bond types are immutable. This is intended to keep referential transparency and to obtain reproducible results with automatic propety update mechamisms described later.
- If you really need mutable atoms and bonds, dict-like objects are acceptable as property types (but in that case, most of the features in this library will no longer work).
"
